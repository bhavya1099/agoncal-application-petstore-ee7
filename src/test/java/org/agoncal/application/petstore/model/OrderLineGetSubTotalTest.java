...
public class OrderLineGetSubTotalTest {
    @Test
    @Tag("valid")
    @DisplayName("Scenario 1: Test to verify the calculation of subtotal when item and quantity are not null")
    public void testSubtotalCalculationWithValidInputs() {
        ...
        // Assert
        assertEquals(50.0f, result, "Subtotal calculation failed with valid inputs");
    }
    @Test
    @Tag("invalid")
    @DisplayName("Scenario 2: Test to verify the getSubTotal() method when item is null")
    public void testSubtotalCalculationWithNullItem() {
        ...
        orderLine.setQuantity(5);
        // Act & Assert
        assertThrows(NullPointerException.class, orderLine::getSubTotal, "Expected getSubTotal() to throw NullPointerException when item is null but it didn't");
    }
    @Test
    @Tag("invalid")
    @DisplayName("Scenario 3: Test to verify the getSubTotal() method when quantity is null")
    public void testSubtotalCalculationWithNullQuantity() {
        ...
        // Act & Assert
        assertThrows(NullPointerException.class, orderLine::getSubTotal, "Expected getSubTotal() to throw NullPointerException when quantity is null but it didn't");
    }
    @Test
    @Tag("invalid")
    @DisplayName("Scenario 4: Test to verify the getSubTotal() method when both item and quantity are null")
    public void testSubtotalCalculationWithNullItemAndQuantity() {
        ...
        orderLine.setQuantity(null);
        // Act & Assert
        assertThrows(NullPointerException.class, orderLine::getSubTotal, "Expected getSubTotal() to throw NullPointerException when both item and quantity are null but it didn't");
    }
}