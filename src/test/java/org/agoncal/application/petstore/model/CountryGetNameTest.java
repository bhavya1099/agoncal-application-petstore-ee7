...
Execution:
  Arrange: Create an instance of Country and set its name to "S�o Tom� & Pr�ncipe".
  Act: Call the getName method on this instance.
  Assert: Assert that the result of getName is "S�o Tom� & Pr�ncipe".
Validation:
...
public class CountryGetNameTest {
	...
	public void getNameWithSpecialCharacters() {
		...
		assertEquals("São Tomé & Príncipe", country.getName());
	}
