...
public class CountryGetNameTest {
	...
	public void getNameWithStandardName() {
		// Using the default constructor and setting the name
	...
	public void getNameWithNullName() {
		// Using the default constructor and setting the name to null
		Country country = new Country();
	...
	public void getNameWithEmptyString() {
		// Using the default constructor and setting the name to an empty string
		Country country = new Country();
		country.setName("");
		String result = country.getName();
		assertEquals("", result);
	...
	public void getNameWithSpecialCharacters() {
		// Using the default constructor and setting the name with special characters
		Country country = new Country();
	...
	public void getNameWithLongString() {
		// Using the default constructor and setting the name with a long string
		Country country = new Country();
