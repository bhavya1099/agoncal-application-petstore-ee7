...
public class CustomerEqualsTest {
	...
	public void testEqualsWithSameInstance() {
		...
		assertTrue("Should return true when the same instance is compared", customer.equals(customer));
	}
	...
	public void testEqualsWithNull() {
		Customer customer = new Customer();
		assertFalse("Should return false when null is compared", customer.equals(null));
	}
	...
	public void testEqualsWithDifferentClass() {
		Customer customer = new Customer();
		String differentClassObject = "Not a Customer";
		assertFalse("Should return false when an object of a different class is compared",
				customer.equals(differentClassObject));
	}

	@Test
	@Category(Categories.invalid.class)
	public void testEqualsWithDifferentLogin() {
		Customer customer1 = new Customer("John", "Doe", "login1", "password", "john.doe@example.com",
				new Address("Street 1", "City", "Zipcode", new Country()));
		Customer customer2 = new Customer("Jane", "Doe", "login2", "password", "jane.doe@example.com",
				new Address("Street 2", "City", "Zipcode", new Country()));
		assertFalse("Should return false when customers have different logins", customer1.equals(customer2));
	}

	@Test
	@Category(Categories.valid.class)
	public void testEqualsWithSameLogin() {
		Customer customer1 = new Customer("John", "Doe", "login123", "password", "john.doe@example.com",
				new Address("Street 1", "City", "Zipcode", new Country()));
		Customer customer2 = new Customer("Jane", "Doe", "login123", "password", "jane.doe@example.com",
				new Address("Street 2", "City", "Zipcode", new Country()));
		assertTrue("Should return true when customers have the same login", customer1.equals(customer2));
	}
