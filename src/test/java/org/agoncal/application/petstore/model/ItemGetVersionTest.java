...
public class ItemGetVersionTest {
    ...
    public void testGetVersionWithSpecificValue() {
        ...
        //Assert
        assertEquals(5, actualVersion, "The expected version is 5");
    }
    @Tag("boundary")
    @Test
    public void testGetVersionWithoutSettingValue() {
        ...
        int actualVersion = item.getVersion();
        //Assert
        assertEquals(0, actualVersion, "The expected version is 0, as the version is not set for the Item object");
    }
    @Tag("invalid")
    @Test
    public void testGetVersionWithNegativeValue() {
        ...
        int actualVersion = item.getVersion();
        //Assert
        assertEquals(-5, actualVersion, "The expected version is -5, as the version is set to a negative value for the Item object");
    }
}