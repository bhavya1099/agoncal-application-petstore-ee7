...
public class AddressEqualsTest {
	...
	public void testTwoIdenticalAddresses() {
		Country country = new Country("US", "United States", "USA", "840", "United States of America");
	...
	public void testAddressesWithDifferentStreet1() {
		Country country = new Country("US", "United States", "USA", "840", "United States of America");
		Address address1 = new Address("123 Main St", "Springfield", "12345", country);
		Address address2 = new Address("124 Main St", "Springfield", "12345", country);
	...
	public void testAddressesWithDifferentCity() {
		Country country = new Country("US", "United States", "USA", "840", "United States of America");
		Address address1 = new Address("123 Main St", "Springfield", "12345", country);
		Address address2 = new Address("123 Main St", "Shelbyville", "12345", country);
		assertFalse(address1.equals(address2));
	}
	...
	public void testAddressesWithDifferentZipcode() {
		Country country = new Country("US", "United States", "USA", "840", "United States of America");
		Address address1 = new Address("123 Main St", "Springfield", "12345", country);
		Address address2 = new Address("123 Main St", "Springfield", "54321", country);
		assertFalse(address1.equals(address2));
	}
