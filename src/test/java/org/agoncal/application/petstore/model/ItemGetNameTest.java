...
"Scenario 1: Test to check if getName method returns the correct name.
  ...
  Execution:
    ...
    Act: Invoke the getName method on the Item instance.
    Assert: Use JUnit assertions to compare the actual result returned by getName method against the expected name of the item.
  Validation: 
    This assertion aims to verify if the getName method correctly returns the name of the item. The expected result is the name that was set to the item. This test is significant as it checks the basic functionality of the getName method which is used to retrieve the name of the item.
...
Scenario 2: Test to check if getName method returns null when no name is set.
  ...
  Validation: 
    This assertion aims to verify if the getName method correctly returns null when no name is set to the item. The expected result is null as no name was set to the item. This test is significant as it checks the behavior of the getName method when no name is set to the item.

Scenario 3: Test to check if getName method returns the latest set name.
  
  Details:  
    TestName: shouldReturnLatestSetName.
    Description: This test is meant to check if getName method returns the latest set name when the name of the item is changed. The target scenario is when the name of the item is updated and we want to retrieve the latest name. 
  Execution:
    Arrange: Create an instance of the Item class and set a name. Then, change the name by calling setName method again with a new name.
    Act: Invoke the getName method on the Item instance.
    Assert: Use JUnit assertions to compare the actual result returned by getName method against the latest set name of the item.
  Validation: 
    This assertion aims to verify if the getName method correctly returns the latest set name of the item. The expected result is the latest set name. This test is significant as it checks the functionality of the getName method when the name of the item is updated.
*/
...
public class ItemGetNameTest {
    ...
    public void shouldReturnCorrectName() {
        ...
        // Assert
        assertEquals("Test Item", actualName, "The name returned by getName method does not match the expected name");
    }
    @Test
    @Tag("invalid")
    ...
    @Test
    @Tag("boundary")
    public void shouldReturnLatestSetName() {
        // Arrange
        Item item = new Item();
        item.setName("Test Item");
        ...
        String actualName = item.getName();
        // Assert
        assertEquals("Updated Test Item", actualName, "The name returned by getName method does not match the latest set name");
    }
}