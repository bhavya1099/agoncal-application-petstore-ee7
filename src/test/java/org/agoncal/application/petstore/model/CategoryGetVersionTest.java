...
public class CategoryGetVersionTest {
    ...
    public void testGetVersionWhenSet() {
        ...
        int version = category.getVersion();
        // Assert
        assertEquals(5, version, "The version should be equal to the set value");
    }
    @Test
    @Tag("boundary")
    public void testGetVersionWhenSetToNegative() {
        ...
        int version = category.getVersion();
        // Assert
        assertEquals(-3, version, "The version should be equal to the set negative value");
    }
    @Test
    @Tag("boundary")
    public void testGetVersionWhenSetToZero() {
        ...
        int version = category.getVersion();
        // Assert
        assertEquals(0, version, "The version should be zero when set to zero");
    }
}