...
Execution:
- Arrange: Create an instance of `Address` and set the city using `setCity("San José")`.
- Act: Invoke `getCity()` on the created instance.
- Assert: Use JUnit assertions to verify that the returned city name is "San José".
Validation:
