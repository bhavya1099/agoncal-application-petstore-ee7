...
Execution:
  Arrange: Create an instance of the Country class and set its name to "C�te d'Ivoire".
  Act: Call the toString method on the instance.
  Assert: Assert that the result of the toString method equals "C�te d'Ivoire".
Validation:
...
public class CountryToStringTest {
	...
	public void testToStringWithStandardName() {
		...
		assert country.toString().equals(expected);
	}
	...
	public void testToStringWithNullName() {
		...
		assert country.toString() == expected;
	}
	...
	public void testToStringWithLongName() {
		...
		String expected = "The United Kingdom of Great Britain and Northern Ireland";
		assert country.toString().equals(expected);
	}
