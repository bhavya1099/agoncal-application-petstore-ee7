...
public class AddressGetStreet2Test {
    ...
    public void testGetStreet2WithValue() {
        ...
        // Assert
        assertEquals("123 Main St", result, "getStreet2() should return the correct value when street2 has a value");
    }
    @Test
    @Tag("boundary")
    public void testGetStreet2WithNullValue() {
        ...
        String result = address.getStreet2();
        // Assert
        assertNull(result, "getStreet2() should return null when street2 is null");
    }
    @Test
    @Tag("invalid")
    public void testGetStreet2WithEmptyString() {
        ...
        String result = address.getStreet2();
        // Assert
        assertEquals("", result, "getStreet2() should return an empty string when street2 is an empty string");
    }
}