...
Execution:
  Arrange: Create an instance of the Country class and set the printableName with a string that includes special characters (e.g., "Na��o@123").
  Act: Call the getPrintableName method to retrieve the printable name.
...
public class CountryGetPrintableNameTest {
	...
	public void retrievePrintableNameWithSpecialCharacters() {
		Country country = new Country();
		country.setPrintableName("Naçõ@123");
		assertEquals("Naçõ@123", country.getPrintableName());
	}
	...
	public void retrievePrintableNameWithMaximumLength() {
		Country country = new Country();
		String maxName = generateStringOfLength(255);
		country.setPrintableName(maxName);
		assertEquals(maxName, country.getPrintableName());
	}

	// Helper method to generate a string of a specified length
