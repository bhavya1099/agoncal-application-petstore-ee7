...
public class CategoryEqualsTest {
	...
	public void compareCategoriesWithSameName() {
		// Arrange
		Category category1 = new Category("Books", "A collection of written, printed, illustrated, or blank sheets.");
	...
	public void compareCategoriesWithDifferentNames() {
		// Arrange
		Category category1 = new Category("Books", "A collection of written, printed, illustrated, or blank sheets.");
		Category category2 = new Category("Movies", "A series of moving pictures.");
		// Act
		boolean result = category1.equals(category2);
		// Assert
		assertFalse(result);
	...
	public void compareCategoryWithNull() {
		// Arrange
		Category category = new Category("Books", "A collection of written, printed, illustrated, or blank sheets.");
		// Act
	...
	public void compareCategoryWithDifferentClassObject() {
		...
		// Act
		boolean result = category.equals(differentClassObject);
		// Assert
		assertFalse(result);
	}
