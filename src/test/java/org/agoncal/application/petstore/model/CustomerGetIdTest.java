...
Details:  
  ...
  Description: This test is designed to check the getId method when the id of the Customer is set. 
Execution:
  Arrange: Create a new Customer object and set the id to a non-null value.
  Act: Invoke the getId method on the created Customer object.
  Assert: Assert that the returned id matches the set id.
Validation: 
  The assertion verifies that the getId method correctly returns the set id of the Customer. This test is significant as it validates the correct functionality of the getId method when the id is set.

Scenario 3: Test for negative Id

Details:  
  TestName: testGetIdWhenNegative.
  Description: This test is designed to check the getId method when the id of the Customer is a negative number. 
Execution:
  Arrange: Create a new Customer object and set the id to a negative value.
  Act: Invoke the getId method on the created Customer object.
  Assert: Assert that the returned id matches the set negative id.
Validation: 
  The assertion verifies that the getId method correctly returns the negative id of the Customer. This test is significant as it validates the correct functionality of the getId method when the id is a negative number.
"""
*/
...
class CustomerGetIdTest {
    ...
    void testGetIdWhenNegative() {
        ...
        Long id = customer.getId();
        // Assert
        assertEquals(expectedId, id, "Expected id to match the set negative id");
    }
}