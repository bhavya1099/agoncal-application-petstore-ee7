...
""""
Scenario 1: Test for Null Id

Details:  
  TestName: testGetIdWhenNull.
  Description: This test is designed to check the getId method when the id of the Customer is null. 
Execution:
  Arrange: Create a new Customer object without setting the id.
  Act: Invoke the getId method on the created Customer object.
  Assert: Assert that the returned id is null.
Validation: 
  The assertion verifies that the getId method correctly returns null when the id of the Customer is not set. This test is significant as it validates the correct functionality of the getId method when handling null values.

Scenario 2: Test for Non-Null Id

Details:  
  TestName: testGetIdWhenNotNull.
  Description: This test is designed to check the getId method when the id of the Customer is not null. 
Execution:
  Arrange: Create a new Customer object and set a non-null id.
  Act: Invoke the getId method on the created Customer object.
  Assert: Assert that the returned id is the same as the set id.
Validation: 
  The assertion verifies that the getId method correctly returns the set id of the Customer. This test validates the correct functionality of the getId method when handling non-null values.

Scenario 3: Test for Id Type

Details:  
  TestName: testGetIdType.
  Description: This test is designed to check the return type of the getId method. 
Execution:
  Arrange: Create a new Customer object and set a non-null id.
  Act: Invoke the getId method on the created Customer object.
  Assert: Assert that the returned id is of type Long.
Validation: 
  The assertion verifies that the getId method correctly returns a Long type id. This test validates the correct return type of the getId method, ensuring that it matches the expected type. 

Scenario 4: Test for Changing Id

Details:  
  TestName: testGetIdAfterChange.
  Description: This test is designed to check the getId method after the id of the Customer has been changed. 
Execution:
  Arrange: Create a new Customer object and set an id. Then, change the id to a different value.
  Act: Invoke the getId method on the created Customer object.
  Assert: Assert that the returned id is the same as the newly set id.
Validation: 
  The assertion verifies that the getId method correctly reflects changes to the id of the Customer. This test validates the correct functionality of the getId method when the id is changed after being set.
"""
*/
...
public class CustomerGetIdTest {
    ...
    public void testGetIdWhenNull() {
        ...
        // Assert
        assertNull(id, "The id should be null when not set");
    }
    @Test
    @Tag("valid")
    public void testGetIdWhenNotNull() {
        ...
        Long id = customer.getId();
        // Assert
        assertEquals(expectedId, id, "The id should be the same as the set id");
    }
    @Test
    @Tag("valid")
    public void testGetIdType() {
        ...
        Long id = customer.getId();
        // Assert
        assertTrue(id instanceof Long, "The id should be of type Long");
    }
    @Test
    @Tag("valid")
    public void testGetIdAfterChange() {
        ...
        Long id = customer.getId();
        // Assert
        assertEquals(newId, id, "The id should be the same as the newly set id");
    }
}